...
namespace DataAccessLayer.Mappings
{
    internal class CompanyMapConfig : IEntityTypeConfiguration<Company>
    {
        public void Configure(EntityTypeBuilder<Company> builder)
        {
            ...
            builder.Property(c => c.UF).IsUnicode(false).IsRequired().HasColumnName("UF");
            builder.Property(c => c.CNPJ).HasMaxLength(18).IsUnicode(false).IsRequired().HasColumnName("CNPJ");
        }
    }
}
